...
for profile in default chaos fig8-hunt read-hunt lease-drift membership-hunt; do
...

{
    ...
    read -r net_rate net_row <<<"$(slowest_steps_per_s '^(default|chaos|fig8-hunt|read-hunt|lease-drift|membership-hunt)$')"
